...
function cps_hc_gems_admin_sidebar() {
	...
	<div uk-sticky="offset: 108; bottom: #bottom">
		...
		<div class="uk-card uk-card-small uk-card-default uk-card-hover uk-margin-bottom">
			<div class="uk-card-header uk-background-muted">
				<h3 class="uk-card-title"><?php esc_html_e( 'HuCommerce Pro', 'surbma-magyar-woocommerce' ); ?> <a class="uk-float-right uk-margin-small-top" uk-icon="icon: more-vertical" uk-toggle="target: #hucommercepro"></a></h3>
			</div>
			<div id="hucommercepro" class="uk-card-body">
				<p><?php esc_html_e( 'Get access to all features of HuCommerce! The version of HuCommerce Pro will bring you even more awesome features for your webshop. By purchasing the premium version, you can support the development and maintenance of the plugin.', 'surbma-magyar-woocommerce' ); ?></p>
			</div>
			<div class="uk-card-footer uk-background-muted">
				<p><a href="https://www.hucommerce.hu/hc/vasarlas/hc-pro/" class="uk-button uk-button-default uk-button-danger uk-button-large uk-width-1-1" target="_blank"><span class="dashicons dashicons-cart" style="position: relative;top: 15px;left: -10px;"></span> <?php esc_html_e( 'HuCommerce Pro', 'surbma-magyar-woocommerce' ); ?></a></p>
			</div>
		</div>
		<?php // * HUCOMMERCE END ?>
		<div class="uk-card uk-card-small uk-card-default uk-card-hover">
			<div class="uk-card-header uk-background-muted">
				<h3 class="uk-card-title"><?php esc_html_e( 'Informations', 'surbma-magyar-woocommerce' ); ?> <a class="uk-float-right uk-margin-small-top" uk-icon="icon: more-vertical" uk-toggle="target: #informations"></a></h3>
			</div>
			<div id="informations" class="uk-card-body">
				...
				<p>
					...
					<br><a href="https://wordpress.org/support/plugin/surbma-magyar-woocommerce/reviews/#new-post" target="_blank">Új értékelés létrehozása</a>
				</p>
				<?php // * HUCOMMERCE END ?>
			</div>
			<div class="uk-card-footer uk-background-muted">
				<p class="uk-text-center"><?php esc_html_e( 'License: GPLv3 or later License', 'surbma-magyar-woocommerce' ); ?></p>
			</div>
		</div>
	</div>
	<?php
...
add_action( 'admin_notices', function() {
	...
	<div data-dismissible="hucommerce-pro-promo-60" class="notice notice-info notice-alt notice-large is-dismissible">
		...
		<p><strong>FONTOS!</strong> Ez a HuCommerce legutolsó nem fizetős verziója, amiben az összes eddigi modul és funkció elérhető. Amennyiben újabb verzióra frissítesz, bizonyos funkciók nem lesznek elérhetők mentés után. Ez egy stabil és biztonságos verzió, de további frissítéseket, támogatást nem kap. Minden további fejlesztés a HuCommerce Pro verziójában kap helyet, amire mindenképpen érdemes előfizetni, hiszen nem csak javításokat tartalmaz, hanem rengeteg új és hasznos funkcióval bővül szinte minden hónapban.</p>
		<p>A HuCommerce Pro megvásárlásával a további fejlesztést, biztonsági frissítéseket is támogatod. Egy ilyen bővítmény karbantartása napi szinten igényel odafigyelést és munkát. A HuCommerce Pro ára úgy lett kialakítva, hogy mindenkinek megérje, hiszen az éves díja egy programozó pár órás munkadíja.</p>
