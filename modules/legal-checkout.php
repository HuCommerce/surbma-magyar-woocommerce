...
add_action( 'woocommerce_register_form', static function() {
	...
	$regacceptppValue = isset( $cps_hc_gems_options['regacceptpp'] ) ? wp_kses_post( wp_unslash( $cps_hc_gems_options['regacceptpp'] ) ) : __( 'I\'ve read and accept the <a href="/privacy-policy/" target="_blank">Privacy Policy</a>', 'surbma-magyar-woocommerce' );
...
add_action( $legalconfirmationsposition, static function( $checkout = '' ) {
	...
	$accepttosValue = isset( $cps_hc_gems_options['accepttos'] ) ? wp_kses_post( wp_unslash( $cps_hc_gems_options['accepttos'] ) ) : __( 'I\'ve read and accept the <a href="/tos/" target="_blank">Terms of Service</a>', 'surbma-magyar-woocommerce' );
	$acceptppValue = isset( $cps_hc_gems_options['acceptpp'] ) ? wp_kses_post( wp_unslash( $cps_hc_gems_options['acceptpp'] ) ) : __( 'I\'ve read and accept the <a href="/privacy-policy/" target="_blank">Privacy Policy</a>', 'surbma-magyar-woocommerce' );
